...
#### POST `/project-view/select`
Project ビューで指定アセットを選択し、Project ウィンドウを前面化して ping 表示する。
...
| ツール | API | 説明 |
|--------|-----|------|
| `select_project_view_asset` | POST `/project-view/select` | Project ビューでアセットを選択し、前面化して ping 表示 |
