...
{
    [McpServerTool(Name = "start_game_view_recording", ReadOnly = false),
     Description(
         ...
         "Call stop_game_view_recording to stop and save the recording."),
     UsedImplicitly]
    ...
    [McpServerTool(Name = "stop_game_view_recording", ReadOnly = false),
     Description(
