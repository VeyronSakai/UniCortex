...
{
    [McpServerTool(Name = "start_game_view_record", ReadOnly = false),
     Description(
         ...
         "Call stop_game_view_record to stop and save the recording."),
     UsedImplicitly]
    ...
    [McpServerTool(Name = "stop_game_view_record", ReadOnly = false),
     Description(
