...
{
    [TestFixture]
    internal sealed class StopTimelineHandlerTest
    {
        [Test]
        public void Handle_Returns200_WhenValid()
        {
            ...
            var handler = new StopTimelineHandler(useCase);

            var router = new RequestRouter();
            handler.Register(router);

            var request = new StopTimelineRequest { instanceId = 12345 };
            var context = new FakeRequestContext(HttpMethodType.Post, ApiRoutes.TimelineStop,
