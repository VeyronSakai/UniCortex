...
{
    [TestFixture]
    internal sealed class SendInputSystemMouseEventHandlerTest
    {
        [Test]
        public void Handle_Returns200_WhenValid()
        {
            ...
            var handler = new SendInputSystemMouseEventHandler(useCase);

            var router = new RequestRouter();
            handler.Register(router);

            var context = new FakeRequestContext(HttpMethodType.Post, ApiRoutes.InputSystemMouse,
