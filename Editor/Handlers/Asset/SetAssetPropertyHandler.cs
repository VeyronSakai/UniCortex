...
{
    internal sealed class SetAssetPropertyHandler
    {
        private readonly SetAssetPropertyUseCase _useCase;

        public SetAssetPropertyHandler(SetAssetPropertyUseCase useCase)
        {
            _useCase = useCase;
        }
        ...
        {
            router.Register(HttpMethodType.Post, ApiRoutes.AssetSetProperty, HandleAsync);
        }
        ...
        private async Task HandleAsync(IRequestContext context, CancellationToken cancellationToken)
        {
            ...
            var request = JsonUtility.FromJson<SetAssetPropertyRequest>(body);
            ...
            var json = JsonUtility.ToJson(new SetAssetPropertyResponse(true));
